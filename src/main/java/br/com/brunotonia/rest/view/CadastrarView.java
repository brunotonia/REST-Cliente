...
public class CadastrarView extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        URL url;
        try {
            url = new URL("http://localhost:8080/CD_REST_Servidor/dados/carro/adicionar");
            ...
            if (http_status / 100 != 2) {
                Logger.getLogger(CadastrarView.class.getName()).log(Level.SEVERE, "Ocorreu algum erro. Codigo de reposta: {0}", http_status);
            }
