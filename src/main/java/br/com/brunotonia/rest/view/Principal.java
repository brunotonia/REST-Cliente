package br.com.brunotonia.rest.view;

import br.com.brunotonia.rest.util.JTableUtil;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblEnciclopedia.setText("Cliente REST - Carros");
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        ...
        Carro[] carros = null;
        try {
            URL url = new URL("http://localhost:8080/CD_REST_Servidor/dados/carro/listar");
            connection = (HttpURLConnection) url.openConnection();
            InputStream is = connection.getInputStream();
            InputStreamReader isr = new InputStreamReader(is);
            Gson gson = new Gson();
            ...
            carros = gson.fromJson(reader, Carro[].class);
